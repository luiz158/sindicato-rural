...
public class NotaCobrancaBean implements Serializable {
	...
	public void selecionaCliente() {
		debitos = listasDAO.getDebitosDoClienteNoStatus(clienteSelecionado, StatusDebitoEnum.DEBITOCRIADO);
	}
	...
	public List<Cliente> getClientes() {
		clientes = listasDAO.getClientesComDebitosNoStatus(StatusDebitoEnum.DEBITOCRIADO);
		return clientes;
	}
